        ...
        <div className="mx-auto flex w-full max-w-6xl items-center gap-4 px-4 py-4 sm:px-6">
          <div className="flex flex-1 items-center gap-3 overflow-hidden">
            <Link to="/" className="flex items-center gap-2 text-lg font-semibold tracking-tight">
              <svg id="Translate language icon" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='size-10'>
                <path fill-rule="evenodd" clip-rule="evenodd" d="M13.7149 14.5214C13.9649 14.5604 14.2389 14.5694 14.6269 14.5694C14.7739 14.5694 14.9729 14.5344 15.1809 14.4884L14.4559 13.0684L13.7149 14.5214Z" fill="#FFFFFF"></path>
