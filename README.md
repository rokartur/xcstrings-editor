...
If you open the app from a hosted URL (for example `https://xcstrings.rokartur.com/`) and try to call local Ollama (`127.0.0.1:11434`), Ollama may reject requests because of CORS (403 / `ERR_BLOCKED_BY_CLIENT` in browser console).
...
```bash
launchctl setenv OLLAMA_ORIGINS "https://xcstrings.rokartur.com,http://127.0.0.1:11434"
```
...
```bash
env OLLAMA_ORIGINS="https://xcstrings.rokartur.com,http://127.0.0.1:11434" ollama serve
```
...
```ini
[Service]
Environment="OLLAMA_ORIGINS=https://xcstrings.rokartur.com,http://127.0.0.1:11434"
```
...
- Name: `OLLAMA_ORIGINS`
- Value: `https://xcstrings.rokartur.com,http://127.0.0.1:11434`
...
```bash
curl -i -H "Origin: https://xcstrings.rokartur.com" http://127.0.0.1:11434/api/tags
```
